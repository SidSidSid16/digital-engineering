...
signal clk_source, rst_source, en_source : STD_LOGIC;
...
--   active-high and synchronous to the 100MHZ clock.
debouncers: for i in 0 to 4 generate
	button_debouncer : entity work.Debouncer 
	PORT MAP(
		CLK => GCLK,
		Sig => BTN(i),
		Deb_Sig => btn_db(i) -- (4=U, 3=C, 2=R, 1=L, 0=D)
	);
end generate;
...
PORT MAP(
	CLK_100MHZ => GCLK,
	USER_PB => btn_db, 		   -- (4=U, 3=C, 2=R, 1=L, 0=D)
